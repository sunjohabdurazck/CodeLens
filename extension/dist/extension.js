...
var HttpsProxyAgent = __webpack_require__(64);
var http = __webpack_require__(9);
var https = __webpack_require__(10);
var http2 = __webpack_require__(82);
var util = __webpack_require__(5);
var path = __webpack_require__(8);
var followRedirects = __webpack_require__(83);
...
const agent_1 = __importDefault(__webpack_require__(65));
...
const net_1 = __importDefault(__webpack_require__(66));
const tls_1 = __importDefault(__webpack_require__(67));
const url_1 = __importDefault(__webpack_require__(11));
const assert_1 = __importDefault(__webpack_require__(68));
const debug_1 = __importDefault(__webpack_require__(69));
const agent_base_1 = __webpack_require__(78);
const parse_proxy_response_1 = __importDefault(__webpack_require__(81));
...
const debug_1 = __importDefault(__webpack_require__(69));
const promisify_1 = __importDefault(__webpack_require__(80));
...
async function scoreAndShow(prompt) {
    try {
        const response = await axios_1.default.post(SCORE_SERVER_URL, { prompt }, { timeout: 5000 });
        const score = response.data.score;
        vscode.window.showInformationMessage(`CodeLens quality estimate: ${score.toFixed(2)}`);
    }
    catch (err) {
        vscode.window.showErrorMessage(`CodeLens: could not reach scoring server at ${SCORE_SERVER_URL}. ` +

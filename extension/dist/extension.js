...
exports.SCORE_SERVER_URL = void 0;
exports.scorePrompt = scorePrompt;
const axios_1 = __webpack_require__(3);
const SCORE_SERVER_URL = "http://localhost:8000/score";
exports.SCORE_SERVER_URL = SCORE_SERVER_URL;
async function scorePrompt(prompt, timeoutMs = 5000) {
    const response = await axios_1.default.post(SCORE_SERVER_URL, { prompt }, { timeout: timeoutMs });
...
var HttpsProxyAgent = __webpack_require__(65);
var http = __webpack_require__(10);
var https = __webpack_require__(11);
var http2 = __webpack_require__(83);
var util = __webpack_require__(6);
var path = __webpack_require__(9);
var followRedirects = __webpack_require__(84);
...
const agent_1 = __importDefault(__webpack_require__(66));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const net_1 = __importDefault(__webpack_require__(67));
const tls_1 = __importDefault(__webpack_require__(68));
const url_1 = __importDefault(__webpack_require__(12));
const assert_1 = __importDefault(__webpack_require__(69));
const debug_1 = __importDefault(__webpack_require__(70));
const agent_base_1 = __webpack_require__(79);
const parse_proxy_response_1 = __importDefault(__webpack_require__(82));
...
const debug_1 = __importDefault(__webpack_require__(70));
const promisify_1 = __importDefault(__webpack_require__(81));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.showScorePanel = showScorePanel;
const vscode = __webpack_require__(1);
...
const vscode = __webpack_require__(1);
const scorer_1 = __webpack_require__(2);
const statusBar_1 = __webpack_require__(87);
const scorePanel_1 = __webpack_require__(88);
...
async function scoreAndShow(context, prompt) {
    (0, statusBar_1.showLoading)();
    try {
        const score = await (0, scorer_1.scorePrompt)(prompt);
        (0, statusBar_1.showScore)(score);
        (0, scorePanel_1.showScorePanel)(context, prompt, score, defaultSuggestions(score, prompt));
    }
    catch (err) {
        const message = `CodeLens: could not reach scoring server at ${scorer_1.SCORE_SERVER_URL}. ` +
            `Is it running? (uvicorn src.models.student.serve:app --port 8000)`;
        (0, statusBar_1.showError)(message);
